...
提供通用的API频率限制管理功能，用于控制API调用频率，避免触发频率限制。
"""
...
class RateLimitManager:
    ...
    def __init__(self, base_delay: float = 0.5, max_requests_per_minute: int = 1800):
        ...
        self.max_requests_per_minute = max_requests_per_minute  # 可配置的API限制
        self.lock = Lock()
